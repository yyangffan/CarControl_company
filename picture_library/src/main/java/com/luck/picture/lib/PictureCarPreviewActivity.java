 ...
 * @描述: 预览图片
 */
public class PictureCarPreviewActivity extends PictureBaseActivity implements View.OnClickListener {
                ...
                longImageView.setOnLongClickListener(v -> {
                    if (config.isNotPreviewDownload) {
                        if (PermissionChecker.checkSelfPermission(getContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                            ...
                            PermissionChecker.requestPermissions(PictureCarPreviewActivity.this,
